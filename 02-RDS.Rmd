...
2. Construct confidence intervals to compare the models. 
...
Among different regression lines, parallel regression lines and a single regression line, the most appropriate model for this dataset is `r mcq(c("different regression lines", "parallel regression lines", answer="a single regression line"))`,
